...
export function antColonyEncounter(player: Player): void {
...
//First Encounter
//[Explore Desert]
function firstAntColonyEncounter(player: Player): void {
    clearOutput();
...
//►[Keep Hidden]
function keepHidden(player: Player): void {
...
//►[Play Hero]
function playHero(monster: Monster): void {
    clearOutput();
...
export function consolePhylla(player: Player): void {
    clearOutput();
...
//[Enter The Colony]
//(Explore the Desert)
function enterTheColony(player: Player): void {
    clearOutput();
...
//The Challenges
function antColonyChallenge(player: Player): void {
    clearOutput();
...
function antColiseumFight(monster: Monster): void {
    clearOutput();
...
export function phyllaPCBeatsGnoll(player: Player): void {
    clearOutput();
...
function antGirlGoodEnd(player: Player): void {
    clearOutput();
...
//►Male Continuation
function gigititigitigitigitigityAntGirl(player: Player): void {
    clearOutput();
...
function malePhyllaContinuation(player: Player, x: number): void {
    clearOutput();
...
//PURE ENDING!
function phyllaFirstTimePureBabiesFuckEnding(player: Player): void {
    clearOutput();
    var x: number = player.cockThatFits(phyllaCapacity());
    if (x < 0) x = player.smallestCockIndex();
...
function phyllaCorruptMascEnding(player: Player): void {
    clearOutput();
...
function cuntmuffinLingusPhyllaDickBig(player: Player): void {
    clearOutput();
...
//►Female Continuation
function femalePhyllaFirstFuckGooooo(player: Player): void {
    clearOutput();
...
function femalePhyllaFirstTimePlusCock(player: Player): void {
    clearOutput();
...
function scissorContinue(player: Player, clear: boolean): void {
...
export function introductionToPhyllaFollower(player: Player): void {
...
function phyllaSexMenu(player: Player): void {
    menu();
    if (player.hasCock()) {
...
//►[Talk]
//..(Ant Morph History)
function talkAboutAntHistory(player: Player): void {
    clearOutput();
...
function talkAboutAntMatingAndRituals(player: Player): void {
    clearOutput();
...
function phyllasLifePastAndFuture(player: Player): void {
    clearOutput();
...
//First Time Blowjob:
function phyllaBeeeJays(player: Player): void {
    clearOutput();
...
//Pure BJ:
function purePhyllaBJOver(player: Player): void {
    clearOutput();
    var x: number = player.smallestCockIndex();
...
//[Sure]
function surePhyllaLetsFuck(player: Player): void {
    clearOutput();
    var x: number = player.smallestCockIndex();
...
//[Nope]
function nopeNotOnMouthOrWhateverFuckThisNoise(player: Player): void {
    clearOutput();
...
//Pure BJ Ending
function pureBJEnding(player: Player, linked: boolean = true): void {
...
//Corrupt BJ Ending
function corruptPhyllaEndings(player: Player): void {
    clearOutput();
    var x: number = player.smallestCockIndex();
...
//\"<i>Use Dick</i>\"
function dickPhylla(player: Player): void {
    var x: number = player.biggestCockIndex();
    clearOutput();
...
function lesbianFisting(player: Player): void {
    clearOutput();
...
//(Note: The above option will only be available if Phylla is 'Laying Eggs.')
//While Giving Birth (Male) - Written
function dudesFuckEggLayingBitches(player: Player): void {
    clearOutput();
...
//While Giving Birth (Female) - Written
function birfingSexWithAntsForDasLadies(player: Player): void {
    clearOutput();
...
function orgyWithDatColonyCorruptDudes(player: Player): void {
...
//Orgy w/ Colony (Female)
//You tell Phylla you're interested in 'inspecting' your children.
function antColonyOrgy4Ladies(player: Player): void {
    clearOutput();
...
function phyllaLaysSomeDriderEggs(player: Player): void {
    clearOutput();
...
//Mount Phylla:
function driderDoublePhllaMount(player: Player): void {
    clearOutput();
    ...
    player.orgasm();
    player.dumpEggs();
    if (!pregnancy.isPregnant) pregnancy.knockUpForce(PregnancyStore.PREGNANCY_DRIDER_EGGS, 8 * 24);
    doNext(camp.returnToCampUseOneHour);
}
...
//(Leads to - Success)
//(Leads to - Failure)
function phyllaDigsForGems(player: Player): void {
    clearOutput();
...
//Sex > [Egg Phylla]
function eggDatBitch(player: Player): void {
    clearOutput();
