...
exports.cleanupChanges = cleanupChanges;
/**
 * Check if the class node has an empty body
 * @param node
 */
function hasEmptyClassBody(node) {
 ...
 * @param node
 */
function hasEmptyMethodBody(node) {
 ...
 * @param node
 */
function replaceWithComments(node) {
...
exports.replaceWithComments = replaceWithComments;
